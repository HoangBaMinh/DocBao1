...
import com.example.newspaper.ui.adapters.view_holders.ArtilceHistoryOrSavedViewHolder;
...
public class ArticleRecycleViewAdapter extends BaseRecycleViewAdapter {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (type) {
            ...
            case HISTORY:
                return new ArtilceHistoryOrSavedViewHolder(inflater.inflate(R.layout.item_history_or_saved_view, parent, false));
            case POINT:
                return new ArtilceHistoryOrSavedViewHolder(inflater.inflate(R.layout.item_news_point_view, parent, false));
            default:
